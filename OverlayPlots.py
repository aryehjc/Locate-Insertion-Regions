...
sns.kdeplot(unique_counts_df1['Position'], color='red', linestyle='-', linewidth=2)
plt.xlabel('Position')
...
sns.kdeplot(unique_counts_df2['Position'], color='orange', linestyle='-', linewidth=2)
...
#Edit bins and edgecolors accordingly.
#Change edgecolor to a different colour for each dataset.
