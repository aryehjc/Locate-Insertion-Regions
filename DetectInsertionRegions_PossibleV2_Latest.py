...
for csv in csv_files:
    ...
    with open("TOTAL_May_25_5pm_Insertion_Regions_S_AUREUS.txt", "a") as f:
...
unique_counts_df.to_csv('TOTAL_May_25_5pm_INSERTION_FREQUENCIES_S_AUREUS.csv', sep=',', index=False)
