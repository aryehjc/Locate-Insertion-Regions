...
# somewhere here can try and find the gaps. 
    ...
    def filter_and_sum(row):
        filtered_values = [val for val in row if 173674 < val < 174345] # (1) from here (see below) if high start value eg 125k + end of range 174k, it exceeds range (possibly EOF) that's why Total Indels >100!
